...
import { WorkspaceNavigator } from '@/pages/coslash/components/WorkspaceNavigator';
...
import { loadNavigatorPreferences, type NavigatorRange } from '@/pages/coslash/lib/navigator-preferences';
...
function apiWindowForRange(range: NavigatorRange): TimeWindow {
...
export function CoslashPage() {
  const [range, setRange] = useState<NavigatorRange>(() => loadNavigatorPreferences().range);
