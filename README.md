...
The [product baseline from 2026-09-11](docs/archive/product-baseline-2026-09-11.md)
is a historical inventory of the implemented local capabilities, API, privacy
contracts, storage, setup, and explicitly deferred work at that date.
